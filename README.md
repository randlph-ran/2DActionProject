...
|5日目|5月22日（金）|	ザコ敵の実装と、キャラアクションの実装||	ステージ1のマップ1，2の足場の仮制作、マップ遷移まで対応	|
|6日目|5月23日（土）|	休み|	遅れてる場合は家で作業や素材探索|||
|7日目|5月24日（日）|	休み|	遅れてる場合は家で作業や素材探索|||
|8日目|5月25日（月）|	マップ1，2完成、マップ(Scene遷移)と足場実装|	|ステージ1のマップ2、ボスマップの仮作成、シーン遷移一通り|
|9日目|5月26日（火）|	マップ作成とクリアまでの遷移、ザコ敵の配置実装|	|Playerの死亡処理、ゲームオーバー遷移、Playerの攻撃アニメーション同期設定開始|
