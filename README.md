...
|9日目|6月18日(木)| Enemyバグ修正、新規Enemy追加 |　AI修正  |  |
|10日目|6月19日(金)| Boss改善 |　Bossバグ修正、新規Bossと行動追加  |  |
|11日目|6月22日(月)| 新ステージ追加 |　2-1～Bossマップ構成  |  |
|12日目|6月23日(火)| BGM、演出追加 | OpenEnd|
---
...
| 6/17 | Enemyバグ修正、アイテム実装対応 | アイテム実装とメニュー表示対応中 | 6h |
